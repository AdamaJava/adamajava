...
public enum OldSnpEffConsequence {
	...
	private OldSnpEffConsequence(String name,   int snpRank ) {
	...
	public static String getClassicName(String name ) {
		...
		if (null != name) {
			for (final OldSnpEffConsequence dcEnum : values())  
	...
	public static String getWorstCaseConsequence( String ...strings ) {
		...
		OldSnpEffConsequence worstConsequence = null;
	 ...
	 public static String getUndefinedConsequence( String ...strings ) {
		...
		for (final String consequence : strings) {
			...
			if(impact.equalsIgnoreCase(OldSnpEffConsequence.HIGH_IMPACT))  
				annotations[0] = consequence;
			else if(impact.equalsIgnoreCase(OldSnpEffConsequence.MODERATE_IMPACT))  
				annotations[1] = consequence;
			else if(impact.equalsIgnoreCase(OldSnpEffConsequence.LOW_IMPACT))  
