...
public class subversionof_SampleColumn {
		...
		static public subversionof_SampleColumn getSampleColumn(String test, String control, VcfHeader header){
			
			return new subversionof_SampleColumn(test,  control, header);
		}
		 ...
		 */		
		private subversionof_SampleColumn(String test, String control, VcfHeader header){
