...
@XmlRootElement(name = "PairedEndReport")
public class PairedEndReport {

    @XmlElement(name = "InsertRange", required = true)
    protected PairedEndReport.InsertRange insertRange;
     ...
     *     
     */
    public void setInsertRange(PairedEndReport.InsertRange value) {
     ...
     * {@link PairedEndReport.UniquePairing }
     * 
     * 
     */
