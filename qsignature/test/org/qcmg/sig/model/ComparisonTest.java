...
public class ComparisonTest {
	...
	public void testComparisonConstructor() {
		try {
			new Comparison(null,0, null, 0, 0, 0, 0);
			Assert.fail("Should have thrown an IAE");
		}	catch (IllegalArgumentException iae){}
		
		Comparison c = new Comparison(F1, 0, F2, 0, 0, 0, 0);
		assertEquals(Double.NaN, c.getScore(), 0.00001);
		
		try {
			c = new Comparison(F1, 0, F2, 0, 100, 0, 0);
			Assert.fail("Should have thrown an IAE");
		}	catch (IllegalArgumentException iae){}
		
		try {
			c = new Comparison(F1, 0, F2, 0, -1, 0, 0);
			Assert.fail("Should have thrown an IAE");
		}	catch (IllegalArgumentException iae){}
		try {
			c = new Comparison(F1, -1, F2, 0, 0, 0, 0);
			Assert.fail("Should have thrown an IAE");
		}	catch (IllegalArgumentException iae){}
		try {
			c = new Comparison(F1, 0, F2, -1, 0, 0, 0);
			Assert.fail("Should have thrown an IAE");
		}	catch (IllegalArgumentException iae){}
		try {
			c = new Comparison(F1, 0, F2, 0, 0, -1, 0);
			Assert.fail("Should have thrown an IAE");
		}	catch (IllegalArgumentException iae){}
		try {
			c = new Comparison(F1, 0, F2, 0, 0, 0, -1);
			Assert.fail("Should have thrown an IAE");
		}	catch (IllegalArgumentException iae){}
	}
	...
	public void testComparison() {
		Comparison c = new Comparison(F1, 0, F2, 0, 0, 1, 0);
		assertEquals(0.0, c.getScore(), 0.00001);
		c = new Comparison(F1, 0, F2, 0, 10, 1, 0);
		assertEquals(10.0, c.getScore(), 0.00001);
		c = new Comparison(F1, 0, F2, 0, 10, 20, 0);
		assertEquals(0.5, c.getScore(), 0.00001);
		c = new Comparison(F1, 0, F2, 0, 10, 1000, 0);
		assertEquals(0.01, c.getScore(), 0.00001);
		
		c = new Comparison(F1, 123456, F2, 234567, 99999, 123456, 1234560);
	...
	public void checkComparator() {
		Comparison c1 = new Comparison(F1, 0, F2, 0, 10, 100, 0);
		Comparison c2 = new Comparison(F1, 0, F2, 0, 20, 100, 0);
		assertEquals(-1, c1.compareTo(c2));
		
		c1 = new Comparison(F1, 0, F2, 0, 20, 100, 0);
		assertEquals(0, c1.compareTo(c2));
		
		c1 = new Comparison(F1, 0, F2, 0, 200, 1000, 0);
