...
public class QPGTest {
	...
	public void exampleCtorMultiArg() {
		...
		String date = VcfHeaderUtils.DF.format(new Date());
	...
	public void doesTheComparatorWork() {
		...
		VcfHeader header = new VcfHeader();
		VcfHeaderUtils.addQPGLine(header,order, tool, ver, cl, VcfHeaderUtils.DF.format(new Date()));
		VcfHeaderUtils.addQPGLine(header,order + 1, tool, ver, cl, VcfHeaderUtils.DF.format(new Date()));
