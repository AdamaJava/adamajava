...
//		 new File(DbsnpModeTest.inputName).delete();
	 ...
	 public void sampleidTest() throws Exception{
		 createVerifiedFile();
			...
			mode.retriveSampleColumn(null, null, mode.header);	
			mode.addAnnotation(null);
		...
		public static void createVerifiedFile() throws IOException{
		        ...
		        data.add("chr3\t41281388\t.\tT\tG\t.\tSBIAS\tFLANK=ATTTAGCAAAC;CONF=HIGH\tGT:GD:AC:MR:NNS\t0/1:G/T:A0[0],15[16.53],C1[38],0[0],G0[0],105[27.78],T112[37.92],106[22.47]:105:2\t0/1:G/T:A0[0],15[16.53],C1[38],0[0],G0[0],105[27.78],T112[37.92],106[22.47]:105:2");
		        data.add("chr3\t41281389\t.\tT\tG\t.\tSBIAS\tFLANK=ATTTAGCAAAC;CONF=HIGH\tGT:GD:AC:MR:NNS\t0/1:G/T:A0[0],15[16.53],C1[38],0[0],G0[0],105[27.78],T112[37.92],106[22.47]:105:2\t0/1:G/T:A0[0],15[16.53],C1[38],0[0],G0[0],15[27.78],T112[37.92],106[22.47]:15:2");
