...
public final class Options {
	...
	public Options(final String[] args) throws Exception {
		...
		parser.accepts("infile", Messages.getMessage("INPUT_DESCRIPTION")).withRequiredArg().ofType(String.class).describedAs(
				"inputfile");
		parser.acceptsAll(asList("outfile"), Messages
				.getMessage("INPUT_DESCRIPTION")).withRequiredArg().ofType(String.class).describedAs(
				"inputfile");
