...
public final class Options {
	...
	private static final String MISSION_OUTPUT_OPTION = Messages.getMessage("MISSING_OUTPUT_OPTIONS");
	...
	public Options(final String[] args) throws Exception {
		...
		parser.acceptsAll(asList("t", "type"), TYPE_OPTION_DESCRIPTION)
				.withRequiredArg().ofType(String.class).describedAs("'seq', 'sequence', 'phys', or 'physical'");
		...
		parser.acceptsAll(asList("per-feature"),PER_FEATURE_OPTION_DESCRIPTION);
		...
		parser.accepts("infile", Messages.getMessage(INPUT_DESCRIPTION)).withRequiredArg().ofType(String.class).describedAs("inputfile");
		parser.acceptsAll(asList("outfile"), Messages
				.getMessage("INPUT_DESCRIPTION")).withRequiredArg().ofType(String.class).describedAs("inputfile");
		parser.acceptsAll(asList("f", "feature"), Messages
				.getMessage("FEATURE_DESCRIPTION")).withRequiredArg().ofType(String.class).describedAs("feature");
	...
	public void detectBadOptions() throws Exception {
		...
		if ( ! hasOutputOption()) {
			throw new Exception(MISSION_OUTPUT_OPTION);
		}
