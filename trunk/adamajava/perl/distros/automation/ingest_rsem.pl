...
##############################################################################
#
#  Program:  ingest_rsem.pl
#  Author:   Lynn Fink
#  Created:  2013-04-10
#
# RSEM file ingestion script; copies files from babyjesus
# and archives them in LiveArc
#
# $Id: ingest_rsem.pl 3664 2013-04-10 05:08:54Z l.fink $
#
##############################################################################
...
if($USAGE || (! $SLIDE)) {
	...
	Ingest rsem files into LiveArc
...
# /mnt/seq_results//icgc_pancreatic/CRL_2557_Panc_05_04/rna_seq/rsem/130227_7001238_0114_BC1ELJACXX.lane_2.GCCAAT.genome.bam
$qi->find_bam();

# results files
# /mnt/seq_results//icgc_pancreatic/CRL_2557_Panc_05_04/rna_seq//rsem/
# 130227_7001238_0114_BC1ELJACXX.lane_2.GCCAAT.genes.results
# 130227_7001238_0114_BC1ELJACXX.lane_2.GCCAAT.isoforms.results
# 130227_7001238_0114_BC1ELJACXX.lane_2.GCCAAT.stat/
$qi->find_resultfiles();

# log file
# mnt/seq_raw//130227_7001238_0114_BC1ELJACXX/log/130227_7001238_0114_BC1ELJACXX.lane_2.GCCAAT_rsem_out.log
$qi->find_log();
