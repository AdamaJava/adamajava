...
#
# $Id: ingest_torrent.pl 1937 2012-05-29 05:18:53Z l.fink $
#
##############################################################################
...
if($USAGE || (! $ANALYSIS_FOLDER && ! $GLPID) ) {
        ...
        $0 -a /path/to/analysis/folder/ -log logfile.log

        Required:
	-glpid	  <id>   LIMS process ID
        -i        <dir>  path to analysis folder to ingest [NOT IMPLEMENTED]
