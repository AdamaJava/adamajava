package QCMG::SamTools::Sam::SegmentLite;
use strict;
...
sub get_feature_stream {
    ...
    return QCMG::SamTools::Sam::Segment::Iterator->new(\@features);
}
...
sub seq      {
    my $self   = shift;
    return QCMG::SamTools::PrimarySeq->new(-seq => $self->dna,
				-id  => $self->seq_id);
}
...
package QCMG::SamTools::Sam::Segment::Iterator;
