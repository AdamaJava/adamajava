...
typedef tamFile         QCMG__SamTools__Tam;
typedef faidx_t*        QCMG__SamTools__Sam__Fai;
typedef bamFile         QCMG__SamTools__Bam;
typedef bam_header_t*   QCMG__SamTools__Bam__Header;
typedef bam1_t*         QCMG__SamTools__Bam__Alignment;
typedef bam_index_t*    QCMG__SamTools__Bam__Index;
typedef bam_pileup1_t*  QCMG__SamTools__Bam__Pileup;
typedef struct {
  SV* callback;
  SV* data;
} fetch_callback_data;
...
int bam_fetch_fun (const bam1_t *b, void *data) {
  ...
  alignment_obj = sv_setref_pv(newSV(sizeof(bam1_t)),"QCMG::SamTools::Bam::Alignment",(void*) b2);
...
int invoke_pileup_callback_fun(uint32_t tid, 
 ...
 if (0) {
  ...
  for (i=0;i<n;i++) {
    ...
    sv_setref_pv(p,"QCMG::SamTools::Bam::Pileup",(void*) &pl[i]);
    av_push(pileup,p);
  } 
}
...
MODULE = QCMG::SamTools::Sam PACKAGE = QCMG::SamTools::Tam PREFIX=tam_

QCMG::SamTools::Tam
tam_open(packname="QCMG::SamTools::Tam", filename)
   char * packname
   char * filename
 PROTOTYPE: $$
 CODE:
...
void
tam_DESTROY(tam)
  QCMG::SamTools::Tam tam
  PROTOTYPE: $
  CODE:
     sam_close(tam);

QCMG::SamTools::Bam::Header
tam_header_read2(packname="QCMG::SamTools::Tam", filename)
    char * packname
    char * filename
    PROTOTYPE: $$
    CODE:
...
tam_read1(tam,header,alignment)
    QCMG::SamTools::Tam            tam
    QCMG::SamTools::Bam::Header    header
    QCMG::SamTools::Bam::Alignment alignment
    CODE:
       RETVAL = sam_read1(tam,header,alignment);
    OUTPUT:
       RETVAL

MODULE = QCMG::SamTools::Sam PACKAGE = QCMG::SamTools::Sam::Fai PREFIX=fai_

QCMG::SamTools::Sam::Fai
fai_load(packname="QCMG::SamTools::Sam::Fai", filename)
  char * packname
  char * filename
 PROTOTYPE: $$
 CODE:
...
MODULE = QCMG::SamTools::Sam PACKAGE = QCMG::SamTools::Bam PREFIX=bam_
...
QCMG::SamTools::Bam::Index
bam_index_open(packname="QCMG::SamTools::Bam", filename)
      char * packname
      char * filename
    PROTOTYPE: $$
    CODE:
...
bam_write1(bam,align)
    QCMG::SamTools::Bam            bam
    QCMG::SamTools::Bam::Alignment align
   PROTOTYPE: $$
   CODE:
...
MODULE = QCMG::SamTools::Sam PACKAGE = QCMG::SamTools::Bam::Alignment PREFIX=bama_

QCMG::SamTools::Bam::Alignment
bama_new(package="QCMG::SamTools::Bam::Alignment")
   char * package
   PROTOTYPE: $
   CODE:
      RETVAL = bam_init1();
...
MODULE = QCMG::SamTools::Sam PACKAGE = QCMG::SamTools::Bam::Header PREFIX=bam_

QCMG::SamTools::Bam::Header
bam_new(packname=QCMG::SamTools::Bam::Header)
PROTOTYPE: $
CODE:
...
MODULE = QCMG::SamTools::Sam PACKAGE = QCMG::SamTools::Bam::Index PREFIX=bami_

int
bami_fetch(bai,bfp,ref,start,end,callback,callbackdata=&PL_sv_undef)
  QCMG::SamTools::Bam::Index bai
  QCMG::SamTools::Bam        bfp
  int   ref
  int   start
  int   end
  CV*   callback
...
MODULE = QCMG::SamTools::Sam PACKAGE = QCMG::SamTools::Bam::Pileup PREFIX=pl_

int
pl_qpos(pl)
  QCMG::SamTools::Bam::Pileup pl
  CODE:
    RETVAL = pl->qpos;
  OUTPUT:
    RETVAL
