...
QCMG::SamTools::Bam::PileupWrapper -- Add high-level methods to QCMG::SamTools::Bam::Pileup

=head1 SYNOPSIS

See L<QCMG::SamTools::Sam/The generic fetch() and pileup() methods> for usage of the pileup() method.

=head1 DESCRIPTION

See L<QCMG::SamTools::Bam::Pileup> for documentation of this object's
methods. This class is used by the high-level API to return
QCMG::SamTools::Bam::AlignWrapper objects from the call to alignment() rather
than QCMG::SamTools::Bam::Alignment.
...
sub alignment {
    my $self = shift;
    return QCMG::SamTools::Bam::AlignWrapper->new($self->{pileup}->b,$self->{sam});
}
