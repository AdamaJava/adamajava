...
QCMG::SamTools::Bam::Query -- Object representing the query portion of a BAM/SAM alignment

=head1 SYNOPSIS

Given an alignment retrieved from a QCMG::SamTools::Sam database,
 ...
 my $seq    = $query->seq;    # QCMG::SamTools::PrimarySeq object
...
use QCMG::SamTools::Sam::Constants qw(CIGAR_SYMBOLS BAM_CREF_SKIP BAM_CSOFT_CLIP BAM_CHARD_CLIP);
...
A QCMG::SamTools::PrimarySeq representing the read sequence in REFERENCE
orientation.
...
Return a QCMG::SamTools::PrimarySeq object representing the requested subsequence
on the read.
