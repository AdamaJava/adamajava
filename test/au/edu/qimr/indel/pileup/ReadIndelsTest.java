...
//			System.out.println( "map size " + positionRecordMap.size());
...
//        data1.add("##INFO=<ID=SOMATIC1,Number=0,Type=Flag,Description=\"test1\">");       
...
//        System.out.println("data:  " + data1.hashCode());
//        System.out.println("data2:  " + data2.hashCode());
//         
//        
//	}
