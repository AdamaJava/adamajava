...
public class CreateSubCacheFile {
	...
	public static Map<String, String> createMapFromSequences(Collection<String> sequences, String strand) {
	...
	public static void main(String[] args) throws IOException {
		...
		Map<String, List<String>> sequenceNameMap = RunTiledAlignerCacheFile.getSequencesAndNamesFromFile(args[3], true);
		
		/*
		 * get the tiles to search the tiledAligner for
		 */
		Map<String, String> sequenceTiles = createMapFromSequences(sequenceNameMap.keySet(), strand);
