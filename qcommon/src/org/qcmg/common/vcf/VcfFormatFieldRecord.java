...
public class VcfFormatFieldRecord {
    ...
    /**
     * replace or set new field to format and sample column
    ...
    public String getFormatColumnString() {
        return String.join(Constants.COLON_STRING, keys);
    }
     ...
     * @return the order of existing key; return -1 if not exist
     */
