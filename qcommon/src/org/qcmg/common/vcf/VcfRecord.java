...
public class VcfRecord implements Comparable<VcfRecord> {
    ...
    public static class Builder {
        ...
        public Builder(String chromosome, int position, String ref) {
            this(ChrPointPosition.valueOf(chromosome, position), ref, null);
        }

        public Builder(String chromosome, int position) {
            this(ChrPointPosition.valueOf(chromosome, position), null, null);
        }

        public Builder(ChrPosition cp, String ref) {
            this(cp, ref, null);
        }

        public Builder(ChrPosition cpp) {
            this(cpp, null, null);
        }
        ...
        public Builder allele(String alt) {
            this.alt = alt;
            return this;
        }
        ...
        public Builder qualString(String str) {
            this.qualString = str;
            return this;
        }

        public VcfRecord build() {
            return new VcfRecord(this);
        }
    }
    ...
    /**
     *
     * @param params: a string array with minimum five element, following order:
    ...
    public VcfInfoFieldRecord getInfoRecord() {
        return infoRecord;
    }
    ...
    public String toSimpleString() {
        ...
        return cpp.getChromosome() + TAB +
                cpp.getStartPosition() + TAB +
                (StringUtils.isNullOrEmpty(ref) ? MISSING_DATA_STRING : ref) + TAB +
                (StringUtils.isNullOrEmpty(alt) ? MISSING_DATA_STRING : alt) + NL;
    }
    ...
    public boolean equals(Object obj) {
        ...
        //compare position
        boolean flag = Objects.equals(cpp, other.cpp);
        if (!flag) {
            return flag;
        }

        //compare ref if same position
        flag = Objects.equals(ref, other.ref);
        if (!flag) {
            return flag;
        }

        //compare alleles if same ref
        flag = Objects.equals(alt, other.alt);
        return flag;
