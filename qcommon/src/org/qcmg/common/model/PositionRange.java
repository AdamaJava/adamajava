...
public class PositionRange implements Comparable<PositionRange> {
    ...
    public PositionRange(int start, int end) {
        if (start < 0) {
            throw new IllegalArgumentException("Start position cannot be less than zero");
        }
        if (start > end) {
            throw new IllegalArgumentException("Start position cannot be greater than the end position");
        }
