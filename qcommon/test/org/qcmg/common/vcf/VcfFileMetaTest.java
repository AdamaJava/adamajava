...
public class VcfFileMetaTest {
    ...
    public void ctor() {
        ...
        assertTrue(meta.getCallerSamplePositions().containsKey("1"));
        assertTrue(meta.getCallerSamplePositions().containsKey("2"));
    ...
    public void ctorSingleSampleSingleCaller() {
        ...
        assertTrue(meta.getCallerSamplePositions().containsKey("1"));
        assertFalse(meta.getCallerSamplePositions().containsKey("2"));
        assertArrayEquals(new short[]{0, 1}, meta.getCallerSamplePositions().get("1"));
    }
