...
public class VcfInfoFieldRecordTest {
    ...
    public void setField() {
        ...
        assertTrue(rec.toString().contains("ABCD=5678"));
        assertTrue(rec.toString().contains("1234"));
        assertTrue(rec.toString().contains("XYZ=???"));

        rec.setField("1234", "1234");
        assertTrue(rec.toString().contains("ABCD=5678"));
        assertTrue(rec.toString().contains("1234=1234"));
        assertTrue(rec.toString().contains("XYZ=???"));

        rec = new VcfInfoFieldRecord("END=3;HOMLEN=0;ND=0:28:28:0[0,0]:0:0:27;");
        rec.setField("ND", "0:28:28:0[0,0]:0:0:27");
        assertEquals("END=3;HOMLEN=0;ND=0:28:28:0[0,0]:0:0:27", rec.toString());
        rec.setField("ND", "0:37:36:0[0,0]:0:0:0");
        assertEquals("END=3;HOMLEN=0;ND=0:37:36:0[0,0]:0:0:0", rec.toString());
    }
