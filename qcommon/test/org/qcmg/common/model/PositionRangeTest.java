...
public class PositionRangeTest {
    ...
    public void testConstructor() {
        ...
        Assert.assertNotEquals(pr1, pr2);
    }

    @Test
    public void testComparator() {
        // its just the start position that is taken into account by the comparator
    ...
    public void testIsAdjacentToEnd() {
        PositionRange pr1 = new PositionRange(10, 10);
        Assert.assertTrue(pr1.isAdjacentToEnd(11));
        Assert.assertFalse(pr1.isAdjacentToEnd(0));
        Assert.assertFalse(pr1.isAdjacentToEnd(-1));
        Assert.assertFalse(pr1.isAdjacentToEnd(9));
        Assert.assertFalse(pr1.isAdjacentToEnd(12));
        Assert.assertFalse(pr1.isAdjacentToEnd(Integer.MIN_VALUE));
        Assert.assertFalse(pr1.isAdjacentToEnd(Integer.MAX_VALUE));
    }
    ...
    public void testContainsPosition() {
        ...
        Assert.assertFalse(pr1.containsPosition(-1));
        Assert.assertFalse(pr1.containsPosition(0));
        Assert.assertTrue(pr1.containsPosition(1));
        Assert.assertTrue(pr1.containsPosition(5));
        Assert.assertTrue(pr1.containsPosition(10));
        Assert.assertFalse(pr1.containsPosition(11));
        Assert.assertFalse(pr1.containsPosition(Integer.MAX_VALUE));
        Assert.assertFalse(pr1.containsPosition(Integer.MIN_VALUE));
    }
}
