...
public class AccumulatorTest {
	...
	public void testAccumulator() {
		...
		acc.addBase((byte)'A', (byte)10, true, 1, 1, 2);
		assertEquals("A", acc.getPileup());
		
		acc = new Accumulator(1);
		acc.addBase((byte)'A', (byte)10, true, 1, 1, 2);
		acc.addBase((byte)'A', (byte)10, true, 2, 1, 2);
		...
		acc.addBase((byte)'A', (byte)10, true, 1, 1, 2);
		acc.addBase((byte)'A', (byte)10, true, 2, 1, 2);
		acc.addBase((byte)'C', (byte)10, true, 2, 1, 2);
		acc.addBase((byte)'C', (byte)10, true, 3, 1, 2);
		...
		try {
			acc.addBase((byte)'C', (byte)10, true, 3, 2, 2);
	...
	public void testToSamtoolsPileupString2() {
		...
		acc.addBase((byte)'A', (byte)10, true, 1, 1, 2);
		assertEquals(".", acc.toSamtoolsPileupString('A'));
		acc.addBase((byte)'C', (byte)10, true, 1, 1, 2);
		assertEquals(".C", acc.toSamtoolsPileupString('A'));
		acc.addBase((byte)'G', (byte)10, true, 1, 1, 2);
		assertEquals(".CG", acc.toSamtoolsPileupString('A'));
		acc.addBase((byte)'T', (byte)10, true, 1, 1, 2);
	...
	public void testToSamtoolsPileupStringReverse() {
		Accumulator acc = new Accumulator(1);
		acc.addBase((byte)'A', (byte)10, false, 1, 1, 2);
		assertEquals(",", acc.toSamtoolsPileupString('A'));
	...
	public void testToSamtoolsPileupStringReverse2() {
		...
		acc.addBase((byte)'A', (byte)10, false, 1, 1, 2);
		assertEquals(",", acc.toSamtoolsPileupString('A'));
		acc.addBase((byte)'C', (byte)10, false, 1, 1, 2);
		assertEquals(",c", acc.toSamtoolsPileupString('A'));
		acc.addBase((byte)'G', (byte)10, false, 1, 1, 2);
		assertEquals(",cg", acc.toSamtoolsPileupString('A'));
		acc.addBase((byte)'T', (byte)10, false, 1, 1, 2);
		assertEquals(",cgt", acc.toSamtoolsPileupString('A'));
		assertEquals("a,gt", acc.toSamtoolsPileupString('C'));
		assertEquals("ac,t", acc.toSamtoolsPileupString('G'));
		assertEquals("acg,", acc.toSamtoolsPileupString('T'));
	...
	public void testGetGenotypeEnum() {
		Accumulator acc = new Accumulator(1);
		for (int i = 0 ; i < 10 ; i++) acc.addBase((byte)'A', (byte)10, true, 1, 1, 2);
		assertEquals(GenotypeEnum.AA, acc.getGenotype('A', new Rule(0,20,3), false, 10.0));
		
		acc = new Accumulator(1);
		for (int i = 0 ; i < 10 ; i++) acc.addBase((byte)'A', (byte)10, true, 1, 1, 2);
		for (int i = 0 ; i < 2 ; i++) acc.addBase((byte)'C', (byte)10, true, 1, 1, 2);
		assertEquals(GenotypeEnum.AA, acc.getGenotype('A', new Rule(0,20,3), false, 10.0));
		...
		acc = new Accumulator(1);
		for (int i = 0 ; i < 10 ; i++) acc.addBase((byte)'C', (byte)10, true, 1, 1, 2);
		for (int i = 0 ; i < 9 ; i++) acc.addBase((byte)'G', (byte)10, true, 1, 1, 2);
		for (int i = 0 ; i < 8 ; i++) acc.addBase((byte)'T', (byte)10, true, 1, 1, 2);
	...
	public void testGetPileupElementString() {
		...
		for (int i = 0 ; i < 10 ; i++) acc.addBase((byte)'C', (byte)10, false, 1, 1, 2);
	...
	public void testGetPileup() {
		...
		for (int i = 0 ; i < 5 ; i++) acc.addBase((byte)'G', (byte)10, false, 1, 1, 2);
		assertEquals("AAAAAAAAAAccccccccccggggg", acc.getPileup());
		for (int i = 0 ; i < 3 ; i++) acc.addBase((byte)'T', (byte)10, true, 1, 1, 2);
	...
	public void testContainsMutation() {
		...
		assertEquals(false, acc.containsMutation());
		for (int i = 0 ; i < 10 ; i++) acc.addBase((byte)'T', (byte)10, (i % 2 == 0) ? false : true, 1010100, 1010101, 1010101);
		assertEquals(false, acc.containsMutation());
		for (int i = 0 ; i < 10 ; i++) acc.addBase((byte)'T', (byte)10, (i % 2 == 0) ? false : true, 1010100, 1010101, 1010101);
		assertEquals(false, acc.containsMutation());
		acc.addBase((byte)'G', (byte)10, true, 1010100, 1010101, 1010101);
		assertEquals(true, acc.containsMutation());
		acc.addBase((byte)'A', (byte)10, true, 1010100, 1010101, 1010101);
		assertEquals(true, acc.containsMutation());
		acc.addBase((byte)'C', (byte)10, true, 1010100, 1010101, 1010101);
		assertEquals(true, acc.containsMutation());
	}
	...
	public void testGetBase() {
		...
		acc.addBase((byte)'C', (byte)10, false, 1010100, 1010101, 1010102);
		assertEquals('C', acc.getBase());
		acc.addBase((byte)'C', (byte)10, true, 1010100, 1010101, 1010102);
		assertEquals('C', acc.getBase());
		acc.addBase((byte)'T', (byte)10, true, 1010100, 1010101, 1010102);
		try {
			assertEquals('C', acc.getBase());
	...
	public void testGetPileupQualities() {
		Accumulator acc = new Accumulator(1010101);
		acc.addBase((byte)'G', (byte)'(', true, 1010100, 1010101, 1010102);
		assertEquals("I", acc.getPileupQualities());
		acc.addBase((byte)'G', (byte)'(', true, 1010100, 1010101, 1010102);
		assertEquals("II", acc.getPileupQualities());
		acc.addBase((byte)'A', (byte)'$', false, 1010100, 1010101, 1010102);
		assertEquals("EII", acc.getPileupQualities());
		acc.addBase((byte)'T', (byte)'&', false, 1010100, 1010101, 1010102);
		acc.addBase((byte)'T', (byte)'&', false, 1010100, 1010101, 1010102);
		assertEquals("EIIGG", acc.getPileupQualities());
		acc.addBase((byte)'C', (byte)'\'', false, 1010100, 1010101, 1010102);
		acc.addBase((byte)'C', (byte)'!', true, 1010100, 1010101, 1010102);
		acc.addBase((byte)'C', (byte)'!', false, 1010100, 1010101, 1010102);
		acc.addBase((byte)'C', (byte)'\'', true, 1010100, 1010101, 1010102);
	...
	public void testAddBase() {
		...
		for (int i = 0 ; i < noOfLoops ; i++) {
			...
			acc.addBase((byte)'A', (byte)random.nextInt(101), false, 99100 + whoKnows, 100000, 1000000 + whoKnows);
		}
