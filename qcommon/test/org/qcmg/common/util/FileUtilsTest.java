...
public class FileUtilsTest {
    ...
    public void testOutputFile() throws Exception {
        ...
        // non-existent file, but directory is OK
    ...
    public void testFileCheckSum() throws IOException {
        ...
        Assert.assertEquals(FileUtils.getFileCheckSum(fs[0].getAbsolutePath()), FileUtils.getFileCheckSum(fs[1].getAbsolutePath()));

        //change one of file
        try (Writer writer = new FileWriter(fs[1], true)) {
            writer.write("testing...");
        }
        assertNotEquals(FileUtils.getFileCheckSum(fs[0].getAbsolutePath()), FileUtils.getFileCheckSum(fs[1].getAbsolutePath()));
    ...
    public void testIsFileEmpty() throws IOException {
        ...
        assertTrue(FileUtils.isFileEmpty(emptyFile));
        assertTrue(FileUtils.isFileEmpty(emptyFile.getAbsolutePath()));
        ...
        assertFalse(FileUtils.isFileEmpty(emptyFile));
        assertFalse(FileUtils.isFileEmpty(emptyFile.getAbsolutePath()));
    }
...
//		
    ...
    public void testFindFilesEndingWithFilterNIO() throws IOException {
        ...
        Assert.assertEquals(file, FileUtils.findFilesEndingWithFilterNIO(file.getAbsolutePath(), "test").getFirst());
...
//		File dirPPP = tempFolder.newFolder("PPP");
    ...
    public void testAreInputFilesValid() throws IOException {
        assertFalse(FileUtils.areInputFilesValid());
        assertFalse(FileUtils.areInputFilesValid(null));
        assertFalse(FileUtils.areInputFilesValid(null, null));
        String newFile = tempFolder.newFile().getAbsolutePath();
        assertTrue(FileUtils.areInputFilesValid(newFile));
        assertFalse(FileUtils.areInputFilesValid(newFile, null));
        assertFalse(FileUtils.areInputFilesValid(null, newFile));
    }
