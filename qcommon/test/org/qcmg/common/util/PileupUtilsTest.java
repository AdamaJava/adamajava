...
public class PileupUtilsTest {
    ...
    public void testDoesPileupContainIndel() {
        try {
            assertFalse(PileupUtils.doesPileupContainIndel(null));
            Assert.fail("Should have thrown an exception");
        } catch (IllegalArgumentException iae) {
        }
        try {
            assertFalse(PileupUtils.doesPileupContainIndel(""));
            Assert.fail("Should have thrown an exception");
        } catch (IllegalArgumentException iae) {
        }
        ...
        assertFalse(PileupUtils.doesPileupContainIndel("..."));
        assertFalse(PileupUtils.doesPileupContainIndel("...,,,"));
        assertTrue(PileupUtils.doesPileupContainIndel("...,,,+1a"));
        assertFalse(PileupUtils.doesPileupContainIndel("...,,,^+."));
        assertTrue(PileupUtils.doesPileupContainIndel("...,,,^+.,..,.+2ac"));
        assertFalse(PileupUtils.doesPileupContainIndel("...,,,^+.,..,.^-.,"));
        assertFalse(PileupUtils.doesPileupContainIndel(",,tt,,T.,.T...,T...........T....,T..T.T,t..T......,^PT^M.^-.^F,"));
        assertTrue(PileupUtils.doesPileupContainIndel("....+2CG.....G.........ggG.....,,.g.."));
    }

    @Test
    public void testContainsCharacterNotPrecededByNewRead() {
        assertTrue(PileupUtils.containsCharacterNotPrecededByNewRead("ABC", 'A'));
        assertFalse(PileupUtils.containsCharacterNotPrecededByNewRead("^ABC", 'A'));
        assertFalse(PileupUtils.containsCharacterNotPrecededByNewRead("BBC", 'A'));
        assertFalse(PileupUtils.containsCharacterNotPrecededByNewRead("^BBC", 'A'));
        assertTrue(PileupUtils.containsCharacterNotPrecededByNewRead("BBC1", '1'));
        assertTrue(PileupUtils.containsCharacterNotPrecededByNewRead("^BBC1", '1'));
        assertTrue(PileupUtils.containsCharacterNotPrecededByNewRead("BB^C1", '1'));
        assertTrue(PileupUtils.containsCharacterNotPrecededByNewRead("B^B^C1", '1'));
        assertFalse(PileupUtils.containsCharacterNotPrecededByNewRead("B^B^C^1", '1'));
        assertTrue(PileupUtils.containsCharacterNotPrecededByNewRead("B^B^C^11", '1'));
        assertFalse(PileupUtils.containsCharacterNotPrecededByNewRead("BBC^1^1", '1'));
        assertTrue(PileupUtils.containsCharacterNotPrecededByNewRead("B1BC^1^1", '1'));
    }
