...
public final class Messages {
	...
	static final ResourceBundle messages = ResourceBundle
			.getBundle("org.qcmg.qmule.messages");

	/** The Constant ERROR_PREFIX. */
	static final String ERROR_PREFIX = getProgramName() + ": ";

	/** The Constant USAGE. */
	public static final String USAGE = getMessage("USAGE");
	 ...
	 * @return the message
	 */
	public static String getMessage(final String identifier, final String arg1,
			final String arg2) {
		final String message = Messages.getMessage(identifier);
	 ...
	 * @return the message
	 */
	public static String getMessage(final String identifier, final Object[] arguments) {
		final String message = Messages.getMessage(identifier);
		return MessageFormat.format(message, arguments);
	}
