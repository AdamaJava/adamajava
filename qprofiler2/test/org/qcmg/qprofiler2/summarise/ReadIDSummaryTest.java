...
public class ReadIDSummaryTest { 
	...
	@Test
 	public void patternTest() { 
		...
		// SixColon("<element1>:<element2>:<element3>:<element4>:<element5>:<element6>:<element7>"),    
		...
		// SixColon_Illumina("<instrument>:<run id>:<flowcell id> :<lane>:<tile>:<x-pos>:<y-pos>"),    
