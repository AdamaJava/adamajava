...
public class Q3IndelException extends Exception {
	
	private static final long serialVersionUID = -7765139841201954800L;

    public Q3IndelException(final String identifier) {
        super(Messages.getMessage(identifier));
    }
    public Q3IndelException(final String identifier, final String argument) {
        super(Messages.getMessage(identifier, argument));
    }
    public Q3IndelException(final String identifier, final String argument1, final String argument2) {
