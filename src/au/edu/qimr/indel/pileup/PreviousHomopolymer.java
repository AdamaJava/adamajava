...
public class PreviousHomopolymer {
	...
	QLogger logger = QLoggerFactory.getLogger(PreviousHomopolymer.class);	
	...
	public PreviousHomopolymer(IndelPosition position, final byte[] referenceBase, int homopolymerWindow) {
