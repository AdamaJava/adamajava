...
public final class SnpException extends Exception {
	/**
	 ...
	 *            dictionary
	 */
	public SnpException(final String identifier) {
	 ...
	 *            message.
	 */
	public SnpException(final String identifier, final String param) {
	 ...
	 *            message.
	 */
	public SnpException(final String identifier, final String param0,
			final String param1) {
	 ...
	 */
	public SnpException(final String identifier, final Object[] params) {
